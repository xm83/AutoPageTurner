...
class ScoreFollowingNetMSMDLCHSDeepDoLight(nn.Module):
    ...
    def __init__(self,  perf_shape, score_shape, use_cuda=False, lstm_hidden_dim=12, num_lstm_layers=3):
        ...
        self.lstm_layer = nn.LSTM(512, self.lstm_hidden_dim, self.num_lstm_layers, batch_first=True)   
        # fully connected layer
        self.final_fc = nn.Linear(self.lstm_hidden_dim, 1)  # output is a single value representing distance on the score
    ...
    def forward(self, perf, score):
        ...
        out = out.contiguous().view(-1, self.lstm_hidden_dim)
    ...
    def init_hidden(self, batch_size):
        ...
        hidden = torch.randn(self.num_lstm_layers, batch_size, self.lstm_hidden_dim)
        return hidden
